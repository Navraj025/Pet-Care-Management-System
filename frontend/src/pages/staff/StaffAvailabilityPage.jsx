      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
        ...
        <div className="bg-white dark:bg-slate-900 p-5 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-4 transition-colors">
          ...
          <form onSubmit={handleSaveHours} className="space-y-4 text-xs">
            <div>
              <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">Working Days (Comma separated)</label>
              <input
                type="text"
                value={workingDays}
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">Shift Start</label>
                <input
                  type="text"
                  value={startTime}
              ...
              <div>
                <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">Shift End</label>
                <input
                  type="text"
                  value={endTime}
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">Break Start</label>
                <input
                  type="text"
                  value={breakStart}
              ...
              <div>
                <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">Break End</label>
                <input
                  type="text"
                  value={breakEnd}
            ...
            <div className="flex items-center space-x-2 pt-2">
              <input
                ...
                className="w-4 h-4 text-teal-600 border-slate-300 dark:border-slate-700 rounded focus:ring-teal-500"
              />
              <label htmlFor="isAvailable" className="font-semibold text-slate-800 dark:text-slate-200">
        ...
        <div className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-4 transition-colors">
          ...
          <form onSubmit={handleMarkLeaveDate} className="space-y-4 text-xs">
            ...
            <div>
              <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">Reason for Absence</label>
              <input
                type="text"
                value={leaveReason}
            ...
            <button
              type="submit"
              className="w-full bg-slate-900 dark:bg-slate-800 hover:bg-slate-800 dark:hover:bg-slate-700 text-white font-bold py-3 rounded-xl shadow-md transition-all text-xs"
            >

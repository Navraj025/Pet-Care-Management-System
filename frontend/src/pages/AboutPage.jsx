  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16 space-y-10 sm:space-y-16">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-2 sm:space-y-4">
        ...
        <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-900 dark:text-slate-100">Dedicated to Extraordinary Pet Healthcare</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
        <div className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-3 transition-colors">
          ...
          <h3 className="font-bold text-slate-900 dark:text-slate-100 text-base sm:text-lg">Compassionate Care</h3>
        ...
        <div className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-3 transition-colors">
          ...
          <h3 className="font-bold text-slate-900 dark:text-slate-100 text-base sm:text-lg">Clinical Precision</h3>
          <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
        ...
        <div className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-3 transition-colors sm:col-span-2 lg:col-span-1">
          <div className="w-12 h-12 bg-teal-100 dark:bg-teal-950 text-teal-700 dark:text-teal-300 rounded-2xl flex items-center justify-center font-bold border border-teal-200 dark:border-teal-800">
            <ShieldCheck className="w-6 h-6" />
          </div>
          <h3 className="font-bold text-slate-900 dark:text-slate-100 text-base sm:text-lg">Full Transparency</h3>
          <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-teal-950 to-slate-900 text-white p-6 sm:p-10 lg:p-12 rounded-3xl shadow-xl space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-slate-800 pb-6 gap-4">
          <div className="space-y-1">
            <div className="inline-flex items-center space-x-2 bg-teal-500/20 text-teal-300 px-3 py-1 rounded-full text-[11px] sm:text-xs font-bold">
              <Code className="w-3.5 h-3.5" />
              <span>PROJECT CREDITS & SPECIFICATION</span>
            </div>
            <h3 className="text-xl sm:text-2xl font-extrabold">{developerInfo.projectName}</h3>
            <p className="text-xs text-slate-300">Final Year Software Engineering Project Architecture</p>
          </div>

          <div className="bg-slate-800/80 px-4 py-2 rounded-2xl border border-slate-700 text-xs shrink-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 text-xs text-slate-300">
          ...
          <div className="bg-slate-800/40 p-4 rounded-2xl border border-slate-800 space-y-1">
            ...
            <p className="text-slate-400 text-[11px] truncate">
              <a href={developerInfo.mailtoUrl} className="hover:text-teal-300 transition-colors truncate block">
                {developerInfo.email}
              </a>
            </p>
          </div>

          <div className="bg-slate-800/40 p-4 rounded-2xl border border-slate-800 space-y-1 sm:col-span-2 md:col-span-1">

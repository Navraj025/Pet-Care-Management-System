      ...
      <form onSubmit={handleSaveProfile} className="space-y-8">
          ...
          <div className="relative group flex flex-col items-center">
            ...
            <div className="flex items-center space-x-2 mt-4">
              <button
                ...
                className="px-3.5 py-1.5 bg-teal-50 dark:bg-teal-950 hover:bg-teal-100 dark:hover:bg-teal-900 text-teal-700 dark:text-teal-300 font-bold text-xs rounded-xl border border-teal-200 dark:border-teal-800 transition-colors flex items-center space-x-1.5"
              >
              ...
              {avatarPreview && (
                <button
                  ...
                  className="p-1.5 text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/50 rounded-xl border border-rose-200 dark:border-rose-800 transition-colors"
        ...
        <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-6 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3.5 py-2.5 pl-10 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 rounded-xl focus:ring-2 focus:ring-teal-500 focus:outline-none"
                />
            ...
            <div>
              <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">Email Address (Read-only)</label>
              <div className="relative">
                <input
                  type="email"
                  disabled
                  value={user?.email || ''}
                  className="w-full px-3.5 py-2.5 pl-10 border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/60 text-slate-500 dark:text-slate-400 rounded-xl cursor-not-allowed"
                />
            ...
            {role === 'CUSTOMER' && (
              <>
                <div>
                  <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">Emergency Contact Line</label>
                  <input
                    type="text"
            ...
            {role === 'STAFF' && (
              <>
                <div>
                  <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">Specialization</label>
                  <input
                    type="text"
                ...
                <div className="md:col-span-2">
                  <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">Professional Bio</label>
                  <textarea
                    rows="3"
                    value={bio}
        ...
        <div className="bg-slate-50 dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 text-xs space-y-3 transition-colors">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-slate-600 dark:text-slate-300">
            <div>
              <span className="text-slate-400 dark:text-slate-400 block">Assigned Role:</span>
              <strong className="text-slate-800 dark:text-slate-200 uppercase">{role}</strong>
              <p className="text-[11px] text-slate-400 dark:text-slate-400">System roles can only be updated by Clinic Administrators.</p>
            </div>
            <div>
              <span className="text-slate-400 dark:text-slate-400 block">Account Status:</span>
              <span className="text-emerald-700 dark:text-emerald-400 font-bold">Active & Verified</span>
            </div>
          </div>
        </div>

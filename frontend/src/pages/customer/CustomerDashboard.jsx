      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex justify-between items-center">
            <h3 className="font-bold text-lg text-slate-900 dark:text-slate-100">My Pets Profile</h3>
            <Link to="/customer/pets" className="text-xs font-bold text-teal-600 dark:text-teal-400 hover:underline flex items-center space-x-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {pets.slice(0, 4).map((pet) => (
              <div key={pet.id} className="bg-white dark:bg-slate-900 p-5 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-3 hover:shadow-md transition-all">
                ...
                <div className="text-xs text-slate-600 dark:text-slate-300 space-y-1 bg-slate-50 dark:bg-slate-800/60 p-3 rounded-2xl border border-slate-100 dark:border-slate-700">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-mono text-[11px] text-slate-700 dark:text-slate-300">{pet.microchip_id || 'Not Registered'}</span>
                  </div>
                </div>

                <Link
                  to={`/customer/pets/${pet.id}`}
                  className="block text-center text-xs font-bold text-teal-700 dark:text-teal-300 hover:text-teal-800 bg-teal-50 dark:bg-teal-950/60 py-2 rounded-xl border border-teal-200 dark:border-teal-800 transition-colors"
                >
                  Open Medical File
                </Link>
              </div>
